    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3">dS <sup>sju</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseBoard" class="collapse" aria-labelledby="headingBoard" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="login.jsp">모두 함께 소통</a>
                        ...
                        <a class="collapse-item" href="404.html">교수님과 1대1</a>
                        <a class="collapse-item" href="blank.html">학생간 소통</a>
                    </div>
                </div>
            </li>
